  ...
  return `
    ...
    <div class="resource-summary">
      <div class="res-line">
        ...
        <span class="res-detail">${state.leafClusters} leaves + canopy bonus ${gains.canopyBonus} + height bonus ${gains.heightSunlightBonus || 0} × ${exposure}% exposure × ${season.factorSun} season</span>
      ...
      <div class="res-line">
        ...
        <span class="res-detail">roots ${gains.rootNutrients.toFixed(1)} (including taproot ${gains.taprootNutrients.toFixed(1)}) + allies ${gains.allyNutrients.toFixed(1)} (larger allies share more) + canopy advantage ${gains.shadeNutrients.toFixed(1)} − crowding ${gains.crowdingNutrients.toFixed(1)} + soil ${gains.soilBonus.toFixed(2)} − upkeep ${gains.maintenanceCost}${gains.dormancySavings ? ` (winter dormancy saved ${gains.dormancySavings})` : ''}</span>
