export function createInitialBrowserState({ initialLifeStage }) {
  return {
    ...
    milestones: {},
    announcedActionUnlocks: ['extendRoot'],
...
export function getBrowserElements(documentRef = document) {
  return {
    ...
    mapExplorerZoomIn: documentRef.getElementById('map-explorer-zoom-in'),
    mapExplorerZoomOut: documentRef.getElementById('map-explorer-zoom-out'),
    mapExplorerZoomLabel: documentRef.getElementById('map-explorer-zoom-label'),
    mapExplorerReset: documentRef.getElementById('map-explorer-reset'),
