...
- each life-stage transition announces every newly unlocked real action with a brief explanation of its gameplay benefit, and records the same unlock in the log
